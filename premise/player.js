(function(t, n, s) {
    try {
        ...
        if (!r)
            return;
        !0 && (c = "https://cdn.converteai.net/12a7ceee-e597-47e5-84a3-e83381170bc5/6a9dda26ecfeb9f7ccbefb4d/main.m3u8",
...
function() {
    var n, s, o, i, a, t = document.getElementById("vid-6a9ddacf963a626adcff867e"), e = {
        elementId: "vid-6a9ddacf963a626adcff867e",
        preloads: {},
        config: {
            id: "6a9ddacf963a626adcff867e",
            step: 5,
            config: {
                callActions: {
                    active: !0,
                    ...
                    items: [{
                        ...
                        as_html: !1,
                        name: null,
                        content: "QUERO PAGAR A TAXA",
                        id: "6a9ddd8890b08b39ce84b0fe_fe50fdcf",
                        ...
                        styles: {
                            background_color: "#30a513",
                            background_hover_color: "#4db90f",
                            text_color: "#FFFFFF",
                        ...
                        animation: null,
                        html: null,
                        url: "https://transformacheckout.vercel.app/?id=215&price=197&name=TAXA%20DE%20VERIFICACAO",
                        open_in_new_tab: !0,
                        scroll_enabled: !1,
                        scroll_type: "auto",
                        scroll_offset: 0
                ...
                conversion: [],
                embedVersion: "1788730760-dynamodb",
                fakeBar: {
                    active: !0,
                    alpha: 2,
                    height: 10,
                ...
                miniPlayer: {
                    active: !1,
                    autoEnableOnScroll: !1,
                    autoReturn: !0
                },
                name: "Premise Rewards.mp4",
                ...
                playerInit: {
                    aspectRatio: 54.96,
                    thumbnailKey: "12a7ceee-e597-47e5-84a3-e83381170bc5/players/6a9ddacf963a626adcff867e/thumbnail.jpg",
                    verticalVideo: !1,
                    customId: null
                },
                playerVersion: "v4",
                ...
                smartAutoPlay: {
                    active: !0,
                    items: [{
                        id: "smart_autoplay_6a9ddacf963a626adcff867e_1_0b69e6c3",
                        autoUnmute: !0,
                        name: "Smart Autoplay",
                        number: 1,
                        version: "2",
                        ...
                        elements: [{
                            ...
                            properties: {
                                border: {
                                    color: "#FFFFFF",
                                    size: 2.7291666666666665,
                                    type: "solid"
                                },
                                color: "rgba(197, 60, 128, 0.83)",
                                radius: 10.916666666666666
                            }
                        }, {
                            height: 54.583333333333336,
                            id: "6a9ddb5b4f61c04cfc2196f1",
                            opacity: 1,
                            order: 2,
                            rotation: 0,
                            type: "text",
                            width: 589.5,
                            x: 360.25,
                            y: 225.36111111111111,
                            transformOrigin: null,
                            properties: {
                                align: "center",
                                color: "#FFFFFF",
                                size: 36.388888888888886,
                                value: "Seu vídeo já começou",
                                weight: "700"
                            }
                        }, {
                            height: 54.583333333333336,
                            id: "6a9ddb5b4f61c04cfc2196f2",
                            opacity: 1,
                            order: 3,
                            rotation: 0,
                            type: "text",
                            ...
                            height: 131,
                            id: "6a9ddb5b4f61c04cfc2196f3",
                            opacity: 1,
                            order: 4,
                            rotation: 0,
                            type: "image",
                            width: 185.58333333333334,
                            x: 562.2083333333334,
                            y: 294.5,
                            transformOrigin: null,
                            properties: {
                ...
                video: {
                    cover: "https://images.converteai.net/12a7ceee-e597-47e5-84a3-e83381170bc5/players/6a9ddacf963a626adcff867e/cover.jpg",
                    startQuality: "auto",
                    id: "6a9dda26ecfeb9f7ccbefb4d",
                    aspectRatio: .5496,
                    height: 720,
                    poster: "https://cdn.converteai.net/12a7ceee-e597-47e5-84a3-e83381170bc5/6a9dda26ecfeb9f7ccbefb4d/poster.jpg",
                    width: 1310,
                    drm: !1
                }
            }
    ...
    function l(e) {
        ...
        var t, n = t.hostname.toLowerCase();
        return t.protocol === "http:" ? r(n) : t.protocol === "https:" && (r(n) || c(n))
    }
    e.loadSmartPlayer = function(t) {
        ...
        try {
            ...
            s && (i.test(s) ? u = s : console.warn("Ignoring playerVersion from search params: not a valid version", s))
        } catch (e) {
        ...
        c = "https://scripts.converteai.net/lib/js/smartplayer-wcC/" + u;
        try {
            d = a && a.get("playerHost"),
            d && (r = decodeURIComponent(d),
            l(r) ? c = r : console.warn("Ignoring playerHost from search params: host is not allowed", r))
        } catch (e) {
    ...
    e.next = function(t) {
        ...
        if (t.fn && e[t.fn] && t.children)
            e[t.fn](t.id, t.children, e.next, t.ttl);
